...
export default function login({navigation}){
 ...
 <View style={styles.container}>
    ...
    <TouchableOpacity onPress={() => {navigation.navigate("shop")}} style={styles.googleButton}>
      <Text style={styles.buttonText}>
      Login with Gmail
      </Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => {navigation.navigate("shop")}} style={styles.appleTextBox}>
